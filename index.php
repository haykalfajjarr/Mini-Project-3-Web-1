    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/carou1.jpg" alt="Tempat Ambasum" width="100%" height="500">
          <div class="carousel-caption">
            <h1><b>Ambasum : Modifikasi Ruang dengan Keindahan dan Keunikan</b></h1>
          </div>
        </div>
        <div class="carousel-item">
          <img src="assets/img/carou2.jpg" alt="Lokasi Ambasum" width="100%" height="500">
          <div class="carousel-caption">
            <h1><b>Meningkatkan Interior bersama Ambasum: Ketika Keindahan Berpadu dengan Ketangguhan.</b></h1>
          </div>
        </div>
      </div>
