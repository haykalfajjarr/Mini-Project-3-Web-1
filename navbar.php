<nav class="navbar navbar-expand-lg navbar-dark" style="background-image: linear-gradient(to right, #007bff, #000080);">
    <div class="container">

        <a class="navbar-brand" href="<?= base_url(); ?>">AMBASUM</a>
